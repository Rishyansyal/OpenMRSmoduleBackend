...
| Admin-acties zonder rol-onderscheid | Opgelost | Startup seedt de `Admin`-rol; reminderbeheer, handmatige retries en dataretentie vereisen het `AdminOnly`-beleid. |
